...
library(modelr)
#Load data
load("/Users/mlashleeadams/Downloads/week6_resources_2_2_2/els.Rdata")
```
## Data Categories
# |Name | Descripton
#---   |    ---
...
```{r}
g1<-g1+geom_smooth(method="lm")
g1<-g1+geom_smooth(method = "loess",color="blue")
g1<-g1+geom_smooth(color="red")
# Labels
...
g1b<-g1b+geom_smooth(method = "loess",color="blue")
g1b<-g1b+geom_smooth(color="red")
g1b
```
